    ...
    <div v-if="stage === 1" class="my-1 flex flex-col gap-4">
      ...
      <div class="flex justify-end">
        <button
          ...
          class="mt-2 flex gap-2 items-center px-4 py-2 text-sm font-medium text-white bg-gray-600 border border-transparent rounded-lg hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 disabled:bg-gray-400">
    ...
    <div v-if="stage === 2" class="my-1 flex flex-col gap-1">
      ...
      <div class="flex justify-between">
        ...
        <button
          ...
          @click="nextStage"
          :disabled="!canProceedToNextStage"
          class="flex gap-2 items-center mt-2 px-4 py-2 text-sm font-medium text-white bg-gray-600 border border-transparent rounded-lg hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 disabled:bg-gray-400">
          <ArrowRightIcon class="h-4 w-4" aria-hidden="true" />
          Siguiente
        </button>
        <button
          ...
          class="mt-2 px-4 py-2 text-sm font-medium text-white bg-gray-600 border border-transparent rounded-lg hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 disabled:bg-gray-400">
